"""
Handler: Telegram Stars & Gifts purchase workflow.
Flow: enter_quantity (min 50) → choose_target → [enter_other_id] → payment
...
from states.states import TelegramStarsStates
